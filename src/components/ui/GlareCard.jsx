import { cn } from "../../template/utils/hover-border-gradient-utils";
...
export const GlareCard = ({
    ...
    const backgroundStyle = {
      "--step": "5%",
      "--foil-svg": `url("data:image/svg+xml,%3Csvg width='26' height='26' viewBox='0 0 26 26' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M2.99994 3.419C2.99994 3.419 21.6142 7.43646 22.7921 12.153C23.97 16.8695 3.41838 23.0306 3.41838 23.0306' stroke='rgba(28, 63, 144, 0.5)' stroke-width='5' stroke-miterlimit='3.86874' stroke-linecap='round'/%3E%3C/svg%3E")`,
      "--pattern": "var(--foil-svg) center/100% no-repeat",
      "--rainbow":
        "repeating-linear-gradient( 0deg,rgba(28, 63, 144, 1) calc(var(--step) * 1),rgba(28, 63, 144, 1) calc(var(--step) * 2),rgba(28, 63, 144, 1) calc(var(--step) * 3),rgba(28, 63, 144, 0.8) calc(var(--step) * 4),rgba(28, 63, 144, 0.8) calc(var(--step) * 5),rgba(28, 63, 144, 1) calc(var(--step) * 6) ) 0% var(--bg-y)/200% 700% no-repeat",
      "--diagonal":
        "repeating-linear-gradient( 128deg,#1C3F90 0%,rgba(28, 63, 144, 0.2) 3.8%,rgba(28, 63, 144, 0.2) 4.5%,rgba(28, 63, 144, 0.2) 5.2%,#1C3F90 10%,#1C3F90 12% ) var(--bg-x) var(--bg-y)/300% no-repeat",
      "--shade":
        "radial-gradient( farthest-corner circle at var(--m-x) var(--m-y),rgba(28, 63, 144, 0.4) 12%,rgba(28, 63, 144, 0.3) 20%,rgba(28, 63, 144, 0) 120% ) var(--bg-x) var(--bg-y)/300% no-repeat",
