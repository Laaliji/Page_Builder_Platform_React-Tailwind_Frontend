...
const iconMap = {
  ...
  carousel: faSliders,
  tabs: faLink,
  "progress-bar": faGauge,
  alert: faTriangleExclamation,
  quote: faQuoteLeft,
  timeline: faTimeline,
  "pricing-table": faDollar,
  testimonial: faComment,
  faq: faCircleQuestion,
  countdown: faClock,
  "contact-form": faEnvelope,
  "login-form": faUser,
  "register-form": faUserPlus,
  "image-slider": faImages,
...
export const BlockManager = {
  ...
  blocks: [
    ...
    },
    {
      ...
      category: "Widgets",
      content:
        '<div class="accordion"><h3>Section 1</h3><div><p>Section 1 Content</p></div><h3>Section 2</h3><div><p>Section 2 Content</p></div></div>',
    ...
    },
    {
      ...
      category: "Widgets",
      content:
        '<div class="carousel"><div class="carousel-item">Item 1</div><div class="carousel-item">Item 2</div><div class="carousel-item">Item 3</div></div>',
    ...
    },
    {
      ...
      category: "Widgets",
      content:
        '<div class="tabs"><ul><li>Tab 1</li><li>Tab 2</li></ul><div class="tab-content">Content for Tab 1</div><div class="tab-content">Content for Tab 2</div></div>',
    ...
    },
    {
      ...
      category: "Widgets",
      content:
        '<div class="progress-bar"><div class="progress" style="width: 70%;">70%</div></div>',
    ...
    },
    {
      ...
      label: "Alert",
      category: "Widgets",
      content: '<div class="alert">This is an alert message</div>',
    ...
    },
    {
      ...
      category: "Widgets",
      content:
        '<div class="timeline"><div class="timeline-item">Item 1</div><div class="timeline-item">Item 2</div></div>',
      attributes: { class: "gjs-block-timeline" },
    },
    {
      id: "pricing-table",
      label: "Pricing Table",
      category: "Widgets",
      content:
        '<div class="pricing-table"><div class="pricing-item"><h3>Basic</h3><p>$10</p></div><div class="pricing-item"><h3>Pro</h3><p>$20</p></div></div>',
      attributes: { class: "gjs-block-pricing-table" },
    },
    {
      id: "testimonial",
      label: "Testimonial",
      category: "Widgets",
      content:
        '<div class="testimonial"><p>"This is a testimonial"</p><cite>- Author</cite></div>',
    ...
    },
    {
      ...
      category: "Widgets",
      content:
        '<div class="faq"><h3>Question 1</h3><p>Answer 1</p><h3>Question 2</h3><p>Answer 2</p></div>',
    ...
    },
    {
      ...
      label: "Countdown",
      category: "Widgets",
      content: '<div class="countdown"><span>10:00</span></div>',
    ...
    },
    {
      ...
      category: "Médias",
      content:
        '<div class="image-slider"><div class="slider-item">Image 1</div><div class="slider-item">Image 2</div></div>',
      attributes: { class: "gjs-block-image-slider" },
    },
    {
      id: "newsletter",
      label: "Newsletter",
